"""Dump per-token (tag, pos, morph) after AttributeRuler runs.

Output: testdata/golden/attribute_ruler{_suffix}.json — keyed by case id.
...
OUT = REPO / "testdata" / "golden" / f"attribute_ruler{golden_suffix()}.json"
